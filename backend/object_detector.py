...
class Detector:
    ...
    def infer(self, image_np):
        ...
        # The results array will have (class, confidence, (x, y, w, h)) tuples
            # if detection class exist in pre-defined classes, consider it as positve detection
        results = []
        ...
        # rpn results array will have (class = "object", confidence, (x, y, w, h)) tuples
            # if RPN score greater than threshold, consider it as rpn result
        results_rpn = []
